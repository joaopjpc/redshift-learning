...
- **Par?metros selecionados:** grau=2, alpha Ridge=0.5
...
- **Par?metros:** grau=2, alpha Ridge=0.5
...
| Bias | -0.000039 |
| NMAD | 0.019048 |
| Erro-padr?o do NMAD | 0.000088 |
| Fra??o de outliers catastr?ficos | 0.14% |
| Limiar de outlier catastr?fico | 0.15 |
| Predi??es negativas de redshift | 0 |
...
| Bias | -0.000539 |
| NMAD | 0.019521 |
| Erro-padr?o do NMAD | 0.000075 |
| Fra??o de outliers catastr?ficos | 0.23% |
| Limiar de outlier catastr?fico | 0.15 |
| Predi??es negativas de redshift | 0 |
...
| Bias | 0.081716 |
| NMAD | 0.066268 |
| Erro-padr?o do NMAD | 0.000339 |
| Fra??o de outliers catastr?ficos | 11.55% |
| Limiar de outlier catastr?fico | 0.15 |
| Predi??es negativas de redshift | 1903 |

## Baseline 2 - Polynomial Ridge com magnitudes + erros fotom?tricos (`mag_err`)

- **Feature set:** `mag_err`
- **Features finais:** `u`, `g`, `r`, `i`, `z`, `uErr`, `gErr`, `rErr`, `iErr`, `zErr`
- **Par?metros selecionados:** grau=2, alpha Ridge=5
...
- **Par?metros:** grau=2, alpha Ridge=5
...
| Bias | 0.000021 |
| NMAD | 0.018135 |
| Erro-padr?o do NMAD | 0.000084 |
| Fra??o de outliers catastr?ficos | 0.15% |
| Limiar de outlier catastr?fico | 0.15 |
| Predi??es negativas de redshift | 1 |
...
| Bias | -0.000655 |
| NMAD | 0.018469 |
| Erro-padr?o do NMAD | 0.000081 |
| Fra??o de outliers catastr?ficos | 0.24% |
| Limiar de outlier catastr?fico | 0.15 |
| Predi??es negativas de redshift | 1 |
...
| Bias | 0.004982 |
| NMAD | 0.044098 |
| Erro-padr?o do NMAD | 0.000251 |
| Fra??o de outliers catastr?ficos | 8.11% |
| Limiar de outlier catastr?fico | 0.15 |
| Predi??es negativas de redshift | 1187 |
...
- **Par?metros selecionados:** grau=2, alpha Ridge=1, gate_strength=0.1
...
- **Par?metros:** grau=2, alpha Ridge=1, gate_strength=0.1
...
| Bias | 0.069685 |
| NMAD | 0.056695 |
| Erro-padr?o do NMAD | 0.000268 |
| Fra??o de outliers catastr?ficos | 8.56% |
| Limiar de outlier catastr?fico | 0.15 |
| Predi??es negativas de redshift | 667 |
